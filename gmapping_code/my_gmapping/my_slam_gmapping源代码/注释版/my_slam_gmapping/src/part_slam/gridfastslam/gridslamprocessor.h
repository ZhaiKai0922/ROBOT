...
public:
  ...
  */
  ...
  struct Particle
  {
    ...
    inline void setWeight(double w) {weight = w;}//设置粒子权重
    ...
    //该粒子的累计权重
    double weightSum;
    //该粒子对应的整条轨迹 记录的是粒子的最近的一个节点，即当前节点
    TNode* node; 
