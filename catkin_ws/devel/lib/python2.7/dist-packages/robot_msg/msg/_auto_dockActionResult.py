...
"""autogenerated by genpy from robot_msg/auto_dockActionResult.msg. Do not edit."""
import codecs
import sys
...
class auto_dockActionResult(genpy.Message):
  _md5sum = "a53f0fc49c0fdcc9976dc50170bf022a"
  _type = "robot_msg/auto_dockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_msg/auto_dockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(auto_dockActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_msg.msg.auto_dockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_msg.msg.auto_dockResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.dock_result,) = _get_struct_B().unpack(str[start:end])
      self.result.dock_result = bool(self.result.dock_result)
      return self
