...
class auto_dockActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new auto_dockResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = auto_dockResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new auto_dockActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = auto_dockResult.Resolve(msg.result)
    }
    else {
      resolved.result = new auto_dockResult()
    }
...
module.exports = auto_dockActionResult;
