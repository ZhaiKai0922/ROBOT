...
class auto_dockActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = auto_dockGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new auto_dockActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = auto_dockGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new auto_dockGoal()
    }
...
module.exports = auto_dockActionGoal;
